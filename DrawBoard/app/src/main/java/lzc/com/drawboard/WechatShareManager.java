...
public class WechatShareManager {
    ...
    private void initWechatShare(Context context){
        if (mWXApi == null) {
            mWXApi = WXAPIFactory.createWXAPI(context, "wx2fa8f2142fe52feb", true);
        }
        mWXApi.registerApp("wx2fa8f2142fe52feb");
    }


    public void shareByWebchat(ShareContent shareContent, int shareType, Bitmap bitmap){
        switch (shareContent.getShareWay()) {
            case WECHAT_SHARE_WAY_TEXT:
                shareText(shareContent, shareType);
                break;
            case WECHAT_SHARE_WAY_PICTURE:
                sharePicture(shareType, bitmap);
                break;
     ...
     * 分享图片
     */
    public void sharePicture(int shareType,Bitmap bitmap) {
    ...
    private void shareWebPage(ShareContent shareContent, int shareType) {
        ...
        System.out.println("instant run test");
